...
var exec = function(main){
	...
	for(var y = 0; y < main.img.i.height; y += main.strokeResolution){
		for(var x = 0; x < main.img.i.width; x += main.strokeResolution){
			...
			main.canvas.ctx.moveTo(main.canvas.WIDTH/2+main.innerMargin+x+main.strokeResolution,main.img.y+y);
			main.canvas.ctx.lineTo(main.canvas.WIDTH/2+main.innerMargin+x,main.img.y+y+main.strokeResolution);
