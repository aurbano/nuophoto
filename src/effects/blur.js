var exec = function(main){
	...
	for(var y = 0; y < main.img.i.height; y += main.strokeResolution){
		for(var x = 0; x < main.img.i.width; x += main.strokeResolution){
			...
			main.circle(Math.round(main.canvas.WIDTH/2+x+main.innerMargin+main.strokeResolution/2),Math.round(main.img.y+y+main.strokeResolution/2), main.strokeResolution*10, rad);
			i++;
		}
	}
}
