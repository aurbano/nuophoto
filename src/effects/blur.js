...
var exec = function(main, params, callback){
	...
	for(var y = 0; y < main.canvas.HEIGHT; y += main.strokeResolution){
		for(var x = 0; x < main.canvas.WIDTH; x += main.strokeResolution){
			// Draw strokes
			var rad = main.buffer.ctx.createRadialGradient(Math.round(x+main.strokeResolution/2),Math.round(main.img.y+y+main.strokeResolution/2),0.01,Math.round(x+main.strokeResolution/2),Math.round(main.img.y+y+main.strokeResolution/2), main.strokeResolution+20);
