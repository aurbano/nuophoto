var exec = function(main){
	...
	for(var y = 0; y < main.img.i.height; y += main.strokeResolution){
		for(var x = 0; x < main.img.i.width; x += main.strokeResolution){
			...
			main.canvas.ctx.moveTo(Math.floor(main.canvas.WIDTH/2+x+main.innerMargin+main.strokeResolution/2),main.img.y+y);
			main.canvas.ctx.lineTo(Math.floor(main.canvas.WIDTH/2+x+main.innerMargin+main.strokeResolution/2),main.img.y+y+main.strokeResolution);
